       SUBROUTINE band(param,EAR,PHOTAR,width)
       IMPLICIT NONE

       INTEGER NE,ie
       DOUBLE PRECISION EAR(0:500),PHOTAR(500),width
       DOUBLE PRECISION PARAM(4)

Cf2py intent(in) param(4) 
Cf2py intent(in) EAR(500) 
Cf2py intent(out) PHOTAR(500) 
Cf2py intent(out) width

       DOUBLE PRECISION Eh1,Eh3,alp,beta,e_p,wd,e_b,epiv
       DOUBLE PRECISION nprime,fac,alb,temi,e0,aa,bb
